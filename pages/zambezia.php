...
<head>
    ...
    <title>ZAMBEZIA - Moçmbique - Corona </title>
    <!-- base:css -->
            ...
            <nav class="navbar top-navbar col-lg-12 col-12 p-0">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                            <a class="navbar-brand brand-logo" href="zambezia.php"><img src="../images/logo.png"
                                    alt="logo" /></a>
                            <a class="navbar-brand brand-logo-mini" href="zambezia.php"><img
            ...
            <div class="container">
                <div class="content-wrapper">
                            ...
                            <div class="d-lg-flex align-items-center">
                                <div>
                                    <h6 class="text-dark font-weight-bold mb-2">COVID19</h6>
                                        <h2 class="text-dark font-weight-bold mb-8">ZAMBEZIA - Painel Coronavírus</h2>
                                            <h6 class="font-weight-normal mb-2">Atualizado em : <?php echo $datazambezia['data'];?> </h6>
                                                </div>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ZAMBEZIA - Painel Coronavírus</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                <td><label class="badge badge-light">Registar * Editar</label></td>
                                        ...
                                        <form method="POST" action="../admin/config/Controller.php">
                                            <tbody>
                                                <td class="py-1">
                                                    <button type="submit" name="zambezia_atualizar"class="badge badge-primary"><i class="mdi mdi-cloud-print-outline "></i>Registar</button>
                                                </td>
                                                <td><input type="number" name="Recuperado" class="form-control" placeholder="Recuperado"></td>
                                                <td><input type="number" name="Negativo" class="form-control"placeholder="Negativo"></td>
                                                <td><input type="number" name="Possetivo" class="form-control"placeholder="Possetivo"></td>
                                                <td><input type="number" name="Quarentena" class="form-control" placeholder="Quarentena"> </td>
                                                <td><input type="number" name="Obito" class="form-control" placeholder="Obito"> </td>
                                                <td><h6 class="font-weight-normal mb-2"><?php $mes= date('Y-m-d');$data= date('H-i-s'); echo $mes."   ".$data;?></h6></td>
                                                <tr>
                                                    <td>Numero Total:</td>
