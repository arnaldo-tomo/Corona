...
<head>
    ...
    <title>TETE - Moçmbique - Corona </title>
    <!-- base:css -->
                        ...
                        <ul class="navbar-nav navbar-nav-right">
                            <li class="nav-item dropdown d-lg-flex d-none">
                                ...
                                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                    ...
                                    <p class="mb-0 font-weight-medium float-left dropdown-header">Escolha Tipo de
                                        Relatório</p>
            ...
            <div class="container">
                <div class="content-wrapper">
                        ...
                        <div class="col-sm-6 mb-4 mb-xl-0">
                            <div class="d-lg-flex align-items-center">
                                <div>
                                    ...
                                    <h2 class="text-dark font-weight-bold mb-8">TETE - Painel Coronavírus</h2>
                                    <h6 class="font-weight-normal mb-2">Atualizado em : <?php echo $datatete['tete1'];?>
                                    </h6>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">TETE - Painel Coronavírus</h4>
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><label class="badge badge-dark"> Utitima Data da Atualização</label>
                                                </td>
                                            </tr>
                                        ...
                                        <form method="POST" action="../admin/config/Controller.php">
                                            <tbody>
                                                <td class="py-1">
                                                    <button type="submit" name="tete_atualizar"
                                                ...
                                                <tr>
                                                    <td>Numero Total:</td>
                                                    <td><b><?php echo $Recuperadotete['tete1']; ?></b></td>
                                                    <td><b><?php echo $Negativotete['tete1']; ?></b></td>
                                                    <td><b><?php echo $Possesetivotete['tete1'];?></b></td>
                                                    <td><b><?php echo $Quarentenatete['tete1'];?></b></td>
                                                    <td><b><?php echo $obitotete['tete1']; ?></b></td>
                                                    <td><b><?php echo $datatete['tete1'];?></b></td>
                                                </tr>
                                            </tbody>
                                        </form>
                                    </table>
