...
<head>
    ...
    <title>CABO DELGADO - Moçmbique - Corona </title>
    <!-- base:css -->
            ...
            <div class="container">
                <div class="content-wrapper">
                        ...
                        <div class="col-sm-6 mb-4 mb-xl-0">
                            <div class="d-lg-flex align-items-center">
                                <div>
                                    ...
                                    <h2 class="text-dark font-weight-bold mb-8">CABO DELGADO - Painel Coronavírus</h2>
                                    <h6 class="font-weight-normal mb-2">Atualizado em :
                                        <?php echo $Datacabodelgado['cabodelgado'];?> </h6>
                                </div>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">CABO DELGADO - Painel Coronavírus</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <form method="POST" action="../admin/config/Controller.php">
                                            <tbody>
                                                <td class="py-1">
                                                    <button type="submit" name="cabodelgado_atualizar"
