...
<head>
    ...
    <title>SOFALA - Moçmbique - Corona </title>
    <!-- base:css -->
            ...
            <div class="container">
                <div class="content-wrapper">
                            ...
                            <div class="d-lg-flex align-items-center">
                                <div>
                                    <h6 class="text-dark font-weight-bold mb-2">COVID19</h6>
                                        <h2 class="text-dark font-weight-bold mb-8">SOFOLA - Painel Coronavírus</h2>
                                            <h6 class="font-weight-normal mb-2">Atualizado em : <?php echo $databeira['dado'];?> </h6>
                                                </div>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">SOFOLA - Painel Coronavírus</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <form method="POST" action="../admin/config/Controller.php">
                                            <tbody>
                                                <td class="py-1">
                                                    <button type="submit" name="sofala_atualizar"
